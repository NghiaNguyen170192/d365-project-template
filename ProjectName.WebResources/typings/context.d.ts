...
declare namespace SDK {
  namespace REST {
    function createRecord(object: Account, type: "Account", successCallback: (result: AccountResult) => any, errorCallback: (err: Error) => any): void;
    function deleteRecord(id: string, type: "Account", successCallBack: () => any, errorCallback: (err: Error) => any): void;
    function retrieveRecord(id: string, type: "Account", select: string | null, expand: string | null, successCallback: (result: AccountResult) => any, errorCallback: (err: Error) => any): void;
    function updateRecord(id: string, object: Account, type: "Account", successCallBack: () => any, errorCallback: (err: Error) => any): void;
    function retrieveMultipleRecords(type: "Account", options: string, successCallback: (result: AccountResult[]) => any, errorCallback: (err: Error) => any, onComplete: any): void;
    function createRecord(object: Contact, type: "Contact", successCallback: (result: ContactResult) => any, errorCallback: (err: Error) => any): void;
    function deleteRecord(id: string, type: "Contact", successCallBack: () => any, errorCallback: (err: Error) => any): void;
    function retrieveRecord(id: string, type: "Contact", select: string | null, expand: string | null, successCallback: (result: ContactResult) => any, errorCallback: (err: Error) => any): void;
    function updateRecord(id: string, object: Contact, type: "Contact", successCallBack: () => any, errorCallback: (err: Error) => any): void;
    function retrieveMultipleRecords(type: "Contact", options: string, successCallback: (result: ContactResult[]) => any, errorCallback: (err: Error) => any, onComplete: any): void;
    function createRecord(object: BulkOperationLog, type: "BulkOperationLog", successCallback: (result: BulkOperationLogResult) => any, errorCallback: (err: Error) => any): void;
    function deleteRecord(id: string, type: "BulkOperationLog", successCallBack: () => any, errorCallback: (err: Error) => any): void;
    function retrieveRecord(id: string, type: "BulkOperationLog", select: string | null, expand: string | null, successCallback: (result: BulkOperationLogResult) => any, errorCallback: (err: Error) => any): void;
    function updateRecord(id: string, object: BulkOperationLog, type: "BulkOperationLog", successCallBack: () => any, errorCallback: (err: Error) => any): void;
    function retrieveMultipleRecords(type: "BulkOperationLog", options: string, successCallback: (result: BulkOperationLogResult[]) => any, errorCallback: (err: Error) => any, onComplete: any): void;
    function createRecord(object: ActivityParty, type: "ActivityParty", successCallback: (result: ActivityPartyResult) => any, errorCallback: (err: Error) => any): void;
    function deleteRecord(id: string, type: "ActivityParty", successCallBack: () => any, errorCallback: (err: Error) => any): void;
    function retrieveRecord(id: string, type: "ActivityParty", select: string | null, expand: string | null, successCallback: (result: ActivityPartyResult) => any, errorCallback: (err: Error) => any): void;
    function updateRecord(id: string, object: ActivityParty, type: "ActivityParty", successCallBack: () => any, errorCallback: (err: Error) => any): void;
    function retrieveMultipleRecords(type: "ActivityParty", options: string, successCallback: (result: ActivityPartyResult[]) => any, errorCallback: (err: Error) => any, onComplete: any): void;
    function createRecord(object: Connection, type: "Connection", successCallback: (result: ConnectionResult) => any, errorCallback: (err: Error) => any): void;
    function deleteRecord(id: string, type: "Connection", successCallBack: () => any, errorCallback: (err: Error) => any): void;
    function retrieveRecord(id: string, type: "Connection", select: string | null, expand: string | null, successCallback: (result: ConnectionResult) => any, errorCallback: (err: Error) => any): void;
    function updateRecord(id: string, object: Connection, type: "Connection", successCallBack: () => any, errorCallback: (err: Error) => any): void;
    function retrieveMultipleRecords(type: "Connection", options: string, successCallback: (result: ConnectionResult[]) => any, errorCallback: (err: Error) => any, onComplete: any): void;
    function createRecord(object: msdyn_accountkpiitem, type: "msdyn_accountkpiitem", successCallback: (result: msdyn_accountkpiitemResult) => any, errorCallback: (err: Error) => any): void;
    function deleteRecord(id: string, type: "msdyn_accountkpiitem", successCallBack: () => any, errorCallback: (err: Error) => any): void;
    function retrieveRecord(id: string, type: "msdyn_accountkpiitem", select: string | null, expand: string | null, successCallback: (result: msdyn_accountkpiitemResult) => any, errorCallback: (err: Error) => any): void;
    function updateRecord(id: string, object: msdyn_accountkpiitem, type: "msdyn_accountkpiitem", successCallBack: () => any, errorCallback: (err: Error) => any): void;
    function retrieveMultipleRecords(type: "msdyn_accountkpiitem", options: string, successCallback: (result: msdyn_accountkpiitemResult[]) => any, errorCallback: (err: Error) => any, onComplete: any): void;
    function createRecord(object: msdyn_contactkpiitem, type: "msdyn_contactkpiitem", successCallback: (result: msdyn_contactkpiitemResult) => any, errorCallback: (err: Error) => any): void;
    function deleteRecord(id: string, type: "msdyn_contactkpiitem", successCallBack: () => any, errorCallback: (err: Error) => any): void;
    function retrieveRecord(id: string, type: "msdyn_contactkpiitem", select: string | null, expand: string | null, successCallback: (result: msdyn_contactkpiitemResult) => any, errorCallback: (err: Error) => any): void;
    function updateRecord(id: string, object: msdyn_contactkpiitem, type: "msdyn_contactkpiitem", successCallBack: () => any, errorCallback: (err: Error) => any): void;
    function retrieveMultipleRecords(type: "msdyn_contactkpiitem", options: string, successCallback: (result: msdyn_contactkpiitemResult[]) => any, errorCallback: (err: Error) => any, onComplete: any): void;
    function createRecord(object: RestEntity, type: string, successCallback: (result: RestEntity) => any, errorCallback: (err: Error) => any): void;
    function deleteRecord(id: string, type: string, successCallBack: () => any, errorCallback: (err: Error) => any): void;
    function retrieveRecord(id: string, type: string, select: string | null, expand: string | null, successCallback: (result: RestEntity) => any, errorCallback: (err: Error) => any): void;
    function updateRecord(id: string, object: RestEntity, type: string, successCallBack: () => any, errorCallback: (err: Error) => any): void;
    function retrieveMultipleRecords(type: string, options: string, successCallback: (result: RestEntity[]) => any, errorCallback: (err: Error) => any, onComplete: any): void;
...
interface BulkOperationLogBase extends RestEntity {
}
interface BulkOperationLogResult extends BulkOperationLogBase {
}
interface BulkOperationLog_Select {
}
interface BulkOperationLog extends BulkOperationLogBase {
}
...
interface msdyn_accountkpiitemBase extends RestEntity {
}
interface msdyn_accountkpiitemResult extends msdyn_accountkpiitemBase {
}
interface msdyn_accountkpiitem_Select {
}
interface msdyn_accountkpiitem extends msdyn_accountkpiitemBase {
}
interface msdyn_contactkpiitemBase extends RestEntity {
}
interface msdyn_contactkpiitemResult extends msdyn_contactkpiitemBase {
}
interface msdyn_contactkpiitem_Select {
}
interface msdyn_contactkpiitem extends msdyn_contactkpiitemBase {
}
interface AccountBase extends RestEntity {
  ...
  msdyn_accountkpiid?: SDK.EntityReference | null;
  msdyn_gdproptout?: boolean | null;
  msdyn_salesaccelerationinsightid?: SDK.EntityReference | null;
}
interface Account extends AccountBase {
  CreatedAccount_BulkOperationLogs2?: BulkOperationLog[] | null;
  ...
  SourceAccount_BulkOperationLogs?: BulkOperationLog[] | null;
  ...
  msdyn_account_msdyn_accountkpiitem_accountid?: msdyn_accountkpiitem[] | null;
  msdyn_msdyn_accountkpiitem_account_accountkpiid?: msdyn_accountkpiitem | null;
}
interface AccountResult extends AccountBase {
  CreatedAccount_BulkOperationLogs2?: SDK.Results<BulkOperationLogResult> | null;
  ...
  Referencingaccount_parent_account?: Account | null;
  Referencingmsa_account_managingpartner?: Account | null;
  SourceAccount_BulkOperationLogs?: SDK.Results<BulkOperationLogResult> | null;
  ...
  msdyn_account_msdyn_accountkpiitem_accountid?: SDK.Results<msdyn_accountkpiitemResult> | null;
  msdyn_msdyn_accountkpiitem_account_accountkpiid?: msdyn_accountkpiitem | null;
}
interface Account_Select extends Account_Expand {
  ...
  TeamsFollowed: RestAttribute<Account_Select>;
  ...
  msdyn_accountkpiid: RestAttribute<Account_Select>;
  msdyn_gdproptout: RestAttribute<Account_Select>;
  msdyn_salesaccelerationinsightid: RestAttribute<Account_Select>;
}
interface Account_Filter {
  ...
  msdyn_accountkpiid: XQR.EntityReferenceFilter;
  msdyn_gdproptout: boolean;
  msdyn_salesaccelerationinsightid: XQR.EntityReferenceFilter;
}
interface Account_Expand {
  CreatedAccount_BulkOperationLogs2: RestExpand<Account_Select, BulkOperationLog_Select>;
  ...
  SourceAccount_BulkOperationLogs: RestExpand<Account_Select, BulkOperationLog_Select>;
  ...
  msdyn_account_msdyn_accountkpiitem_accountid: RestExpand<Account_Select, msdyn_accountkpiitem_Select>;
  msdyn_msdyn_accountkpiitem_account_accountkpiid: RestExpand<Account_Select, msdyn_accountkpiitem_Select>;
}
interface RestEntities {
  Account: RestMapping<Account,Account_Select,Account_Expand,Account_Filter,AccountResult>;
}
interface ContactBase extends RestEntity {
  ...
  adx_profilemodifiedon?: Date | null;
  msa_managingpartnerid?: SDK.EntityReference | null;
  msdyn_contactkpiid?: SDK.EntityReference | null;
  msdyn_decisioninfluencetag?: SDK.OptionSet<contact_msdyn_decisioninfluencetag> | null;
  msdyn_disablewebtracking?: boolean | null;
  msdyn_gdproptout?: boolean | null;
  msdyn_isassistantinorgchart?: boolean | null;
  msdyn_isminor?: boolean | null;
  msdyn_isminorwithparentalconsent?: boolean | null;
  msdyn_orgchangestatus?: SDK.OptionSet<contact_msdyn_orgchangestatus> | null;
  msdyn_portaltermsagreementdate?: Date | null;
  mspp_userpreferredlcid?: SDK.OptionSet<powerpagelanguages> | null;
}
interface Contact extends ContactBase {
  CreatedContact_BulkOperationLogs?: BulkOperationLog[] | null;
  ...
  SourceContact_BulkOperationLogs?: BulkOperationLog[] | null;
  ...
  msdyn_contact_msdyn_contactkpiitem_contactid?: msdyn_contactkpiitem[] | null;
  msdyn_msdyn_contactkpiitem_contact_contactkpiid?: msdyn_contactkpiitem | null;
}
interface ContactResult extends ContactBase {
  CreatedContact_BulkOperationLogs?: SDK.Results<BulkOperationLogResult> | null;
  ...
  Referencingcontact_customer_contacts?: Contact | null;
  Referencingcontact_master_contact?: Contact | null;
  SourceContact_BulkOperationLogs?: SDK.Results<BulkOperationLogResult> | null;
  ...
  contact_customer_accounts?: Account | null;
  msa_contact_managingpartner?: Account | null;
  msdyn_contact_msdyn_contactkpiitem_contactid?: SDK.Results<msdyn_contactkpiitemResult> | null;
  msdyn_msdyn_contactkpiitem_contact_contactkpiid?: msdyn_contactkpiitem | null;
}
interface Contact_Select extends Contact_Expand {
  ...
  BusinessCard: RestAttribute<Contact_Select>;
  BusinessCardAttributes: RestAttribute<Contact_Select>;
  ...
  TeamsFollowed: RestAttribute<Contact_Select>;
  ...
  adx_preferredlcid: RestAttribute<Contact_Select>;
  ...
  msdyn_contactkpiid: RestAttribute<Contact_Select>;
  msdyn_decisioninfluencetag: RestAttribute<Contact_Select>;
  msdyn_disablewebtracking: RestAttribute<Contact_Select>;
  msdyn_gdproptout: RestAttribute<Contact_Select>;
  msdyn_isassistantinorgchart: RestAttribute<Contact_Select>;
  msdyn_isminor: RestAttribute<Contact_Select>;
  msdyn_isminorwithparentalconsent: RestAttribute<Contact_Select>;
  msdyn_orgchangestatus: RestAttribute<Contact_Select>;
  msdyn_portaltermsagreementdate: RestAttribute<Contact_Select>;
  mspp_userpreferredlcid: RestAttribute<Contact_Select>;
}
interface Contact_Filter {
  ...
  adx_profilemodifiedon: Date;
  msa_managingpartnerid: XQR.EntityReferenceFilter;
  msdyn_contactkpiid: XQR.EntityReferenceFilter;
  msdyn_decisioninfluencetag: XQR.ValueContainerFilter<contact_msdyn_decisioninfluencetag>;
  msdyn_disablewebtracking: boolean;
  msdyn_gdproptout: boolean;
  msdyn_isassistantinorgchart: boolean;
  msdyn_isminor: boolean;
  msdyn_isminorwithparentalconsent: boolean;
  msdyn_orgchangestatus: XQR.ValueContainerFilter<contact_msdyn_orgchangestatus>;
  msdyn_portaltermsagreementdate: Date;
  mspp_userpreferredlcid: XQR.ValueContainerFilter<powerpagelanguages>;
}
interface Contact_Expand {
  CreatedContact_BulkOperationLogs: RestExpand<Contact_Select, BulkOperationLog_Select>;
  ...
  SourceContact_BulkOperationLogs: RestExpand<Contact_Select, BulkOperationLog_Select>;
  ...
  msdyn_contact_msdyn_contactkpiitem_contactid: RestExpand<Contact_Select, msdyn_contactkpiitem_Select>;
  msdyn_msdyn_contactkpiitem_contact_contactkpiid: RestExpand<Contact_Select, msdyn_contactkpiitem_Select>;
}
interface RestEntities {
  Contact: RestMapping<Contact,Contact_Select,Contact_Expand,Contact_Filter,ContactResult>;
}
interface BulkOperationLogBase extends RestEntity {
  AdditionalInfo?: string | null;
  BulkOperationId?: SDK.EntityReference | null;
  BulkOperationLogId?: string | null;
  CampaignActivityId?: SDK.EntityReference | null;
  CreatedObjectId?: SDK.EntityReference | null;
  ErrorDescriptionFormatted?: string | null;
  ErrorNumber?: number | null;
  ErrorNumberFormatted?: string | null;
  ImportSequenceNumber?: number | null;
...
interface BulkOperationLog extends BulkOperationLogBase {
  BulkOperation_Accounts?: Account[] | null;
  BulkOperation_Contacts?: Contact[] | null;
  CampaignActivity_Accounts?: Account[] | null;
  CampaignActivity_Contacts?: Contact[] | null;
  CreatedAccount_BulkOperationLogs2?: Account | null;
  CreatedContact_BulkOperationLogs?: Contact | null;
  SourceAccount_BulkOperationLogs?: Account | null;
  SourceContact_BulkOperationLogs?: Contact | null;
}
interface BulkOperationLogResult extends BulkOperationLogBase {
  BulkOperation_Accounts?: SDK.Results<AccountResult> | null;
  BulkOperation_Contacts?: SDK.Results<ContactResult> | null;
  CampaignActivity_Accounts?: SDK.Results<AccountResult> | null;
  CampaignActivity_Contacts?: SDK.Results<ContactResult> | null;
  CreatedAccount_BulkOperationLogs2?: Account | null;
  CreatedContact_BulkOperationLogs?: Contact | null;
  SourceAccount_BulkOperationLogs?: Account | null;
  SourceContact_BulkOperationLogs?: Contact | null;
}
interface BulkOperationLog_Select extends BulkOperationLog_Expand {
  AdditionalInfo: RestAttribute<BulkOperationLog_Select>;
  BulkOperationId: RestAttribute<BulkOperationLog_Select>;
  BulkOperationLogId: RestAttribute<BulkOperationLog_Select>;
  CampaignActivityId: RestAttribute<BulkOperationLog_Select>;
  CreatedObjectId: RestAttribute<BulkOperationLog_Select>;
  ErrorDescriptionFormatted: RestAttribute<BulkOperationLog_Select>;
  ErrorNumber: RestAttribute<BulkOperationLog_Select>;
  ErrorNumberFormatted: RestAttribute<BulkOperationLog_Select>;
  ImportSequenceNumber: RestAttribute<BulkOperationLog_Select>;
  Name: RestAttribute<BulkOperationLog_Select>;
  OverriddenCreatedOn: RestAttribute<BulkOperationLog_Select>;
  OwnerId: RestAttribute<BulkOperationLog_Select>;
  OwningBusinessUnit: RestAttribute<BulkOperationLog_Select>;
  OwningTeam: RestAttribute<BulkOperationLog_Select>;
  OwningUser: RestAttribute<BulkOperationLog_Select>;
  RegardingObjectId: RestAttribute<BulkOperationLog_Select>;
  TimeZoneRuleVersionNumber: RestAttribute<BulkOperationLog_Select>;
  UTCConversionTimeZoneCode: RestAttribute<BulkOperationLog_Select>;
  VersionNumber: RestAttribute<BulkOperationLog_Select>;
}
interface BulkOperationLog_Filter {
  AdditionalInfo: string;
  BulkOperationId: XQR.EntityReferenceFilter;
  BulkOperationLogId: XQR.Guid;
  CampaignActivityId: XQR.EntityReferenceFilter;
  CreatedObjectId: XQR.EntityReferenceFilter;
  ErrorDescriptionFormatted: string;
  ErrorNumber: number;
  ErrorNumberFormatted: string;
  ImportSequenceNumber: number;
...
interface BulkOperationLog_Expand {
  BulkOperation_Accounts: RestExpand<BulkOperationLog_Select, Account_Select>;
  BulkOperation_Contacts: RestExpand<BulkOperationLog_Select, Contact_Select>;
  CampaignActivity_Accounts: RestExpand<BulkOperationLog_Select, Account_Select>;
  CampaignActivity_Contacts: RestExpand<BulkOperationLog_Select, Contact_Select>;
  CreatedAccount_BulkOperationLogs2: RestExpand<BulkOperationLog_Select, Account_Select>;
  CreatedContact_BulkOperationLogs: RestExpand<BulkOperationLog_Select, Contact_Select>;
  SourceAccount_BulkOperationLogs: RestExpand<BulkOperationLog_Select, Account_Select>;
  SourceContact_BulkOperationLogs: RestExpand<BulkOperationLog_Select, Contact_Select>;
}
interface RestEntities {
  BulkOperationLog: RestMapping<BulkOperationLog,BulkOperationLog_Select,BulkOperationLog_Expand,BulkOperationLog_Filter,BulkOperationLogResult>;
}
interface ActivityPartyBase extends RestEntity {
  ...
  ResourceSpecId?: SDK.EntityReference | null;
  ScheduledEnd?: Date | null;
  ScheduledStart?: Date | null;
  UnresolvedPartyName?: string | null;
  VersionNumber?: number | null;
...
interface ActivityParty_Select extends ActivityParty_Expand {
  ...
  ResourceSpecId: RestAttribute<ActivityParty_Select>;
  ScheduledEnd: RestAttribute<ActivityParty_Select>;
  ScheduledStart: RestAttribute<ActivityParty_Select>;
  UnresolvedPartyName: RestAttribute<ActivityParty_Select>;
...
interface ActivityParty_Filter {
  ...
  ResourceSpecId: XQR.EntityReferenceFilter;
  ScheduledEnd: Date;
  ScheduledStart: Date;
  UnresolvedPartyName: string;
  VersionNumber: number;
...
interface RestEntities {
  ActivityParty: RestMapping<ActivityParty,ActivityParty_Select,ActivityParty_Expand,ActivityParty_Filter,ActivityPartyResult>;
}
interface ConnectionBase extends RestEntity {
  ConnectionId?: string | null;
  CreatedBy?: SDK.EntityReference | null;
...
interface RestEntities {
  Connection: RestMapping<Connection,Connection_Select,Connection_Expand,Connection_Filter,ConnectionResult>;
}
interface msdyn_accountkpiitemBase extends RestEntity {
  CreatedBy?: SDK.EntityReference | null;
  CreatedOn?: Date | null;
  ...
  UTCConversionTimeZoneCode?: number | null;
  VersionNumber?: number | null;
  msdyn_accountid?: SDK.EntityReference | null;
  msdyn_accountkpiitemId?: string | null;
  msdyn_acilastupdatetimestamp?: Date | null;
  msdyn_averagefirstresponsetimebytheminhrs?: string | null;
  msdyn_averagefirstresponsetimebyusinhrs?: string | null;
  msdyn_computationaccuracy?: SDK.OptionSet<msdyn_kpicomputationaccuracy> | null;
  msdyn_date?: Date | null;
  msdyn_emailattachmentopens?: string | null;
  msdyn_emaillinksclicked?: string | null;
  msdyn_emailsreceived?: number | null;
  msdyn_emailssent?: number | null;
  msdyn_facetimewithcustomer?: number | null;
  msdyn_liemailssent?: number | null;
  ...
  msdyn_meetingssent?: number | null;
  msdyn_name?: string | null;
  msdyn_openedemails?: string | null;
  msdyn_phonecallsmade?: number | null;
  msdyn_phonecallsreceived?: number | null;
  msdyn_relationshiphealthscorestate?: SDK.OptionSet<msdyn_msdyn_accountkpiitem_msdyn_relationshiphealthscorestate> | null;
  msdyn_relationshiphealthscorevalue?: number | null;
  msdyn_relationshiphealthtrend?: SDK.OptionSet<msdyn_msdyn_accountkpiitem_msdyn_relationshiphealthtrend> | null;
  msdyn_responseratebythem?: string | null;
  msdyn_responseratebyus?: string | null;
  msdyn_timespentbycustomer?: number | null;
  msdyn_timespentbycustomer_calculated?: string | null;
  msdyn_timespentbyteam?: number | null;
  msdyn_timespentbyteam_calculated?: string | null;
  statecode?: SDK.OptionSet<msdyn_accountkpiitem_statecode> | null;
  statuscode?: SDK.OptionSet<msdyn_accountkpiitem_statuscode> | null;
}
interface msdyn_accountkpiitem extends msdyn_accountkpiitemBase {
  msdyn_account_msdyn_accountkpiitem_accountid?: Account | null;
  msdyn_msdyn_accountkpiitem_account_accountkpiid?: Account[] | null;
}
interface msdyn_accountkpiitemResult extends msdyn_accountkpiitemBase {
  msdyn_account_msdyn_accountkpiitem_accountid?: Account | null;
  msdyn_msdyn_accountkpiitem_account_accountkpiid?: SDK.Results<AccountResult> | null;
}
interface msdyn_accountkpiitem_Select extends msdyn_accountkpiitem_Expand {
  CreatedBy: RestAttribute<msdyn_accountkpiitem_Select>;
  CreatedOn: RestAttribute<msdyn_accountkpiitem_Select>;
  CreatedOnBehalfBy: RestAttribute<msdyn_accountkpiitem_Select>;
  ImportSequenceNumber: RestAttribute<msdyn_accountkpiitem_Select>;
  ModifiedBy: RestAttribute<msdyn_accountkpiitem_Select>;
  ModifiedOn: RestAttribute<msdyn_accountkpiitem_Select>;
  ModifiedOnBehalfBy: RestAttribute<msdyn_accountkpiitem_Select>;
  OrganizationId: RestAttribute<msdyn_accountkpiitem_Select>;
  OverriddenCreatedOn: RestAttribute<msdyn_accountkpiitem_Select>;
  TimeZoneRuleVersionNumber: RestAttribute<msdyn_accountkpiitem_Select>;
  UTCConversionTimeZoneCode: RestAttribute<msdyn_accountkpiitem_Select>;
  VersionNumber: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_accountid: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_accountkpiitemId: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_acilastupdatetimestamp: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_averagefirstresponsetimebytheminhrs: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_averagefirstresponsetimebyusinhrs: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_computationaccuracy: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_date: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_emailattachmentopens: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_emaillinksclicked: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_emailsreceived: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_emailssent: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_facetimewithcustomer: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_liemailssent: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_meetingsreceived: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_meetingssent: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_name: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_openedemails: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_phonecallsmade: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_phonecallsreceived: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_relationshiphealthscorestate: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_relationshiphealthscorevalue: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_relationshiphealthtrend: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_responseratebythem: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_responseratebyus: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_timespentbycustomer: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_timespentbycustomer_calculated: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_timespentbyteam: RestAttribute<msdyn_accountkpiitem_Select>;
  msdyn_timespentbyteam_calculated: RestAttribute<msdyn_accountkpiitem_Select>;
  statecode: RestAttribute<msdyn_accountkpiitem_Select>;
  statuscode: RestAttribute<msdyn_accountkpiitem_Select>;
}
interface msdyn_accountkpiitem_Filter {
  CreatedBy: XQR.EntityReferenceFilter;
  CreatedOn: Date;
  ...
  UTCConversionTimeZoneCode: number;
  VersionNumber: number;
  msdyn_accountid: XQR.EntityReferenceFilter;
  msdyn_accountkpiitemId: XQR.Guid;
  msdyn_acilastupdatetimestamp: Date;
  msdyn_averagefirstresponsetimebytheminhrs: any;
  msdyn_averagefirstresponsetimebyusinhrs: any;
  msdyn_computationaccuracy: XQR.ValueContainerFilter<msdyn_kpicomputationaccuracy>;
  msdyn_date: Date;
  msdyn_emailattachmentopens: any;
  msdyn_emaillinksclicked: any;
  msdyn_emailsreceived: number;
  ...
  msdyn_phonecallsmade: number;
  msdyn_phonecallsreceived: number;
  msdyn_relationshiphealthscorestate: XQR.ValueContainerFilter<msdyn_msdyn_accountkpiitem_msdyn_relationshiphealthscorestate>;
  msdyn_relationshiphealthscorevalue: number;
  msdyn_relationshiphealthtrend: XQR.ValueContainerFilter<msdyn_msdyn_accountkpiitem_msdyn_relationshiphealthtrend>;
  msdyn_responseratebythem: any;
  msdyn_responseratebyus: any;
  msdyn_timespentbycustomer: number;
  msdyn_timespentbycustomer_calculated: any;
  msdyn_timespentbyteam: number;
  msdyn_timespentbyteam_calculated: any;
  statecode: XQR.ValueContainerFilter<msdyn_accountkpiitem_statecode>;
  statuscode: XQR.ValueContainerFilter<msdyn_accountkpiitem_statuscode>;
}
interface msdyn_accountkpiitem_Expand {
  msdyn_account_msdyn_accountkpiitem_accountid: RestExpand<msdyn_accountkpiitem_Select, Account_Select>;
  msdyn_msdyn_accountkpiitem_account_accountkpiid: RestExpand<msdyn_accountkpiitem_Select, Account_Select>;
}
interface RestEntities {
  msdyn_accountkpiitem: RestMapping<msdyn_accountkpiitem,msdyn_accountkpiitem_Select,msdyn_accountkpiitem_Expand,msdyn_accountkpiitem_Filter,msdyn_accountkpiitemResult>;
}
interface msdyn_contactkpiitemBase extends RestEntity {
  CreatedBy?: SDK.EntityReference | null;
  CreatedOn?: Date | null;
  ...
  msdyn_averagefirstresponsetimebyusinhrs?: string | null;
  msdyn_computationaccuracy?: SDK.OptionSet<msdyn_kpicomputationaccuracy> | null;
  msdyn_contactid?: SDK.EntityReference | null;
  msdyn_contactkpiitemId?: string | null;
  msdyn_date?: Date | null;
  msdyn_emailattachmentopens?: string | null;
  msdyn_emaillinksclicked?: string | null;
  ...
  msdyn_phonecallsmade?: number | null;
  msdyn_phonecallsreceived?: number | null;
  msdyn_relationshiphealthscorestate?: SDK.OptionSet<msdyn_msdyn_contactkpiitem_msdyn_relationshiphealthscorestate> | null;
  msdyn_relationshiphealthscorevalue?: number | null;
  msdyn_relationshiphealthtrend?: SDK.OptionSet<msdyn_msdyn_contactkpiitem_msdyn_relationshiphealthtrend> | null;
  msdyn_responseratebythem?: string | null;
  msdyn_responseratebyus?: string | null;
  msdyn_timespentbycustomer?: number | null;
  msdyn_timespentbycustomer_calculated?: string | null;
  msdyn_timespentbyteam?: number | null;
  msdyn_timespentbyteam_calculated?: string | null;
  statecode?: SDK.OptionSet<msdyn_contactkpiitem_statecode> | null;
  statuscode?: SDK.OptionSet<msdyn_contactkpiitem_statuscode> | null;
}
interface msdyn_contactkpiitem extends msdyn_contactkpiitemBase {
  msdyn_contact_msdyn_contactkpiitem_contactid?: Contact | null;
  msdyn_msdyn_contactkpiitem_contact_contactkpiid?: Contact[] | null;
}
interface msdyn_contactkpiitemResult extends msdyn_contactkpiitemBase {
  msdyn_contact_msdyn_contactkpiitem_contactid?: Contact | null;
  msdyn_msdyn_contactkpiitem_contact_contactkpiid?: SDK.Results<ContactResult> | null;
}
interface msdyn_contactkpiitem_Select extends msdyn_contactkpiitem_Expand {
  CreatedBy: RestAttribute<msdyn_contactkpiitem_Select>;
  CreatedOn: RestAttribute<msdyn_contactkpiitem_Select>;
  CreatedOnBehalfBy: RestAttribute<msdyn_contactkpiitem_Select>;
  ImportSequenceNumber: RestAttribute<msdyn_contactkpiitem_Select>;
  ModifiedBy: RestAttribute<msdyn_contactkpiitem_Select>;
  ModifiedOn: RestAttribute<msdyn_contactkpiitem_Select>;
  ModifiedOnBehalfBy: RestAttribute<msdyn_contactkpiitem_Select>;
  OrganizationId: RestAttribute<msdyn_contactkpiitem_Select>;
  OverriddenCreatedOn: RestAttribute<msdyn_contactkpiitem_Select>;
  TimeZoneRuleVersionNumber: RestAttribute<msdyn_contactkpiitem_Select>;
  UTCConversionTimeZoneCode: RestAttribute<msdyn_contactkpiitem_Select>;
  VersionNumber: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_acilastupdatetimestamp: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_averagefirstresponsetimebytheminhrs: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_averagefirstresponsetimebyusinhrs: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_computationaccuracy: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_contactid: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_contactkpiitemId: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_date: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_emailattachmentopens: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_emaillinksclicked: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_emailsreceived: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_emailssent: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_facetimewithcustomer: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_liemailssent: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_meetingsreceived: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_meetingssent: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_name: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_numberofopportunities: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_openedemails: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_phonecallsmade: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_phonecallsreceived: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_relationshiphealthscorestate: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_relationshiphealthscorevalue: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_relationshiphealthtrend: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_responseratebythem: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_responseratebyus: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_timespentbycustomer: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_timespentbycustomer_calculated: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_timespentbyteam: RestAttribute<msdyn_contactkpiitem_Select>;
  msdyn_timespentbyteam_calculated: RestAttribute<msdyn_contactkpiitem_Select>;
  statecode: RestAttribute<msdyn_contactkpiitem_Select>;
  statuscode: RestAttribute<msdyn_contactkpiitem_Select>;
}
interface msdyn_contactkpiitem_Filter {
  CreatedBy: XQR.EntityReferenceFilter;
  CreatedOn: Date;
  ...
  msdyn_averagefirstresponsetimebyusinhrs: any;
  msdyn_computationaccuracy: XQR.ValueContainerFilter<msdyn_kpicomputationaccuracy>;
  msdyn_contactid: XQR.EntityReferenceFilter;
  msdyn_contactkpiitemId: XQR.Guid;
  msdyn_date: Date;
  msdyn_emailattachmentopens: any;
  msdyn_emaillinksclicked: any;
  msdyn_emailsreceived: number;
  ...
  msdyn_phonecallsmade: number;
  msdyn_phonecallsreceived: number;
  msdyn_relationshiphealthscorestate: XQR.ValueContainerFilter<msdyn_msdyn_contactkpiitem_msdyn_relationshiphealthscorestate>;
  msdyn_relationshiphealthscorevalue: number;
  msdyn_relationshiphealthtrend: XQR.ValueContainerFilter<msdyn_msdyn_contactkpiitem_msdyn_relationshiphealthtrend>;
  msdyn_responseratebythem: any;
  msdyn_responseratebyus: any;
  msdyn_timespentbycustomer: number;
  msdyn_timespentbycustomer_calculated: any;
  msdyn_timespentbyteam: number;
  msdyn_timespentbyteam_calculated: any;
  statecode: XQR.ValueContainerFilter<msdyn_contactkpiitem_statecode>;
  statuscode: XQR.ValueContainerFilter<msdyn_contactkpiitem_statuscode>;
}
interface msdyn_contactkpiitem_Expand {
  msdyn_contact_msdyn_contactkpiitem_contactid: RestExpand<msdyn_contactkpiitem_Select, Contact_Select>;
  msdyn_msdyn_contactkpiitem_contact_contactkpiid: RestExpand<msdyn_contactkpiitem_Select, Contact_Select>;
}
interface RestEntities {
  msdyn_contactkpiitem: RestMapping<msdyn_contactkpiitem,msdyn_contactkpiitem_Select,msdyn_contactkpiitem_Expand,msdyn_contactkpiitem_Filter,msdyn_contactkpiitemResult>;
}
